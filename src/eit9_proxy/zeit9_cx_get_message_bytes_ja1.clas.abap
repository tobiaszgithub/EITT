class ZEIT9_CX_GET_MESSAGE_BYTES_JA1 definition
  public
...
public section.
  ...
  data ERROR_PART type ZEIT9_INVALID_KEY_EXCEPTION read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !ERROR_PART type ZEIT9_INVALID_KEY_EXCEPTION optional
...
CLASS ZEIT9_CX_GET_MESSAGE_BYTES_JA1 IMPLEMENTATION.
